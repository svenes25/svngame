...
<html>
	...
	<body>
		...
		<div class="dukkan">
			...
			<div class="dukkanadı"><h3 style="color:red" align="center">Bahçe</h3></div>
			
			<div class="dukkanarayuz">
				
				<img src="bahce.png" class="dukkanresim">
				<?php
					...
					if($count1)
					{
						...
						else if($row1['sure']<=$anlık)
						{
							...
							{
								if($_SESSION["kullanici"]==$satir["kullanici_adi"] && $satir["urun"]=="meyve")
								{
									break;
								}
							}
							...
							$Guncellebahce= mysqli_query($baglanti,"UPDATE bahce SET adet = 0 WHERE kullanici_adi = '$_SESSION[kullanici]' ");
						...
						else
						{
							...
							echo "<br><a href='fiyatbelirle.php' class='button'>Fiyat Güncelle</a><br>";
